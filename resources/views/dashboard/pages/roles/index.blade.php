                        ...
                        <div class="col-sm-auto ms-auto">
                            <div class="d-flex flex-wrap align-items-start justify-content-end gap-2">
                                <button type="button"
                                        ...
                                        id="create-btn"
                                        data-bs-target="#showModal"><i class="ri-add-line align-bottom me-1"></i> Add Role</button>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-auto ms-auto">
                            <div class="d-flex gap-2">
                                <div class="search-box">
                                    <input type="text" class="form-control search" placeholder="Search for code or title..." id="custom-input-search">
                                    <i class="ri-search-line search-icon"></i>
                                </div>
                                <button class="btn btn-success" id="custom-btn-submit"><i class="ri-equalizer-line align-bottom me-1" ></i> Filters</button>
                            </div>
                        </div>
                        <!--end col-->
                    </div>
    ...
    <script>
        function singleDelete(id){
            Swal.fire({
                ...
                if (result.value) {
                    try {
                        axios.delete('{{route("dashboard.roles.delete")}}', {
                            data: {
                                ids: id
                            }
